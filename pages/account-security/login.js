...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="Log In - earn more"/>
                    ...
                    <div className="sm:border border-gray-300 rounded-xl">
                        <div className="sm:px-24 sm:pt-7 pb-7 flex flex-col justify-center items-center">
                            ...
                            <form className="mt-7 space-y-4 sm:w-auto w-full" onSubmit={HandleForm}>
                                ...
                                <button className="w-full py-2 px-3 bg-[#0C4A6E] rounded-full font-semibold text-white transition hover:bg-[#18465f]" type="submit" onClick={() => router.push("/jobs/all-jobs")}>
                                    Continue with Email
                                </button>
                            </form>
...
*/}
                        ...
                        <div className="lg:px-24 py-7 flex flex-col justify-center items-center border-t border-gray-300 mt-7">
                            ...
                            <div className="flex w-full justify-center items-center">
                                <span className="text-zinc-600"> Don't have an earn more Account? </span>
                            </div>
                            {/* ============== */}
