...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            {/* ============== Head Tag =============== */}
            <HeadTag title="Create an Account - earn more"/>
                            ...
                            <form className="mt-5 space-y-5 sm:w-auto md:w-[42rem] w-full" onSubmit={HandleForm}>
                                ...
                                <div className="flex space-x-3 my-4">
                                    ...
                                    <label htmlFor="yes" className="text-zinc-800 cursor-pointer text-sm">
                                        Yes, I understand and agree to the earn more Terms of Service , including the User Agreement and Privacy Policy
                                    </label>
                                </div>
